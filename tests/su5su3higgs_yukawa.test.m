...
(*Vector bosons*)
RepC=CreateParticle[{1},"V",mv2,"VectorSU5"]
RepA=CreateParticle[{2},"V",mv2,"VectorSU3"]
...
*)
ParticleList={RepPhi,RepPsiL,RepPsiR,RepXiL,RepA,RepC,RepB};
LightParticleList={};
