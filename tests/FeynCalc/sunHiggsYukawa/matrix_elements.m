...
(* ::Input::Initialization:: *)
(* polarization sums *)
polsums[x_,vec_,aux_,spinfac_]:=x//Collect2[#,Pair[_,Momentum[Polarization[vec,__]]]]&//Isolate[#,{Polarization[vec,__]}]&//DoPolarizationSums[#,vec,aux,ExtraFactor->spinfac]&//FixedPoint[ReleaseHold,#]&
...
makeAmplitudeSquared[process_,channels_:All,dropUnphysicalPolarizations_:True]:=Module[{ampM,ampSq, ampMsq,masses,stu,i,j,indexPair},
(* assumes 2->2 topology *)
masses={0,0,0,0};
stu=Plus@@(masses^2);
