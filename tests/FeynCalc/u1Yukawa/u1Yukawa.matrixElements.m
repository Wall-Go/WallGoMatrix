...
(* ::Section:: *)
(*Matrix elements  in U(1) Higgs + Yukawa theory*)
...
(* choose model *)
model = "u1-higgs-yukawa_replaced";
...
interstingParticles={S[1],-S[1],S[2],V[1],F[1],-F[1],F[2],-F[2]};
...
makeAmplitude[process_,channels_:All]:=Module[{diags,ampFA,ampFC,ampSq, ampMsq,ampMsqSummed,masses,transverse,i},
...
ampFC[5]=ampFC[4](*/.{SUNF[a_,b_,c_,d_] -> SUNF[a,b,Index[Adjoint,5]] SUNF[Index[Adjoint,5],c,d]} *);(*/.{SUNT[SUNIndex[Index[Adjoint, a_]]] . SUNT[SUNIndex[Index[Fundamental, \[Beta]_]]] . SUNT[SUNIndex[Index[Fundamental, \[Gamma]_]]]->SUNTF[{SUNIndex[adj[a]]},SUNFIndex[fun[\[Beta]]],SUNFIndex[fun[\[Gamma]]]]} ;*)
...
integerToParticleIndex[1]


integerToParticleIndex[2]
...
externalSignature={S[2],S[2]}->{S[2],S[2]};
ampSq[S]=makeAmplitudeSquared[externalSignature,All,True]//Contract//SUNSimplify
...
externalSignature={S[2],S[2]}->{F[2],-F[2]};
makeAmplitudeSquared[externalSignature,All,True]//Contract//SUNSimplify
...
externalSignature={-S[1],S[2]}->{-S[1],V[1]};
...
(*DoPolarizationSums[%,momenta[[4]],0]//Contract//SUNSimplify
SetMandelstam[s,t,u,p1,p2,-p3,-p4,masses/.List->Sequence];
%%//Simplify//fixConvention
*)
...
particleList = {S[1],-S[1],S[2],V[1],F[1],-F[1],F[2],-F[2]};
