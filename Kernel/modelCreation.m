...
*)
AllocateTensors[GroupI_,RepNameI_,CouplingNameI_,FermionRepI_,ScalarRepI_]:=Module[
	{GroupP=GroupI,RepNameP=RepNameI,CouplingNameP=CouplingNameI,FermionRepP=FermionRepI,ScalarRepP=ScalarRepI},
	Clear[a,b,c,d];
	Needs["GroupMath`"];
